...
export function AudioPlayer() {
  ...
  return (
    <>
      ...
      {showPlayer && currentSong && (<div className={`fixed h-[var(--player-height)] glass border-t border-border animate-slide-up ${
        ytView === 'full'
          ...
          // Normal: sits to the right of the sidebar. Its top border lines up
          // with the sidebar's Settings row (which is sized to player-height).
